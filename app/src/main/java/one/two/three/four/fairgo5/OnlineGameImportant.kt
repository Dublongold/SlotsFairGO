...
import one.two.three.four.fairgo5.online.OnActivityResultHelper
import one.two.three.four.fairgo5.online.RequestPermissionHelper
import one.two.three.four.fairgo5.online.SingleOnBack
import one.two.three.four.fairgo5.online.SingleViewInstaller
...
class OnlineGameImportant : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        singleViewInstaller = SingleViewInstaller(singleView, Firebase.remoteConfig.getString("link"))
        startInstallation()
    }
